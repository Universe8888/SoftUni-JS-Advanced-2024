...
function tomorrowTemplate({ forecast, name }) {
    ...
    wrapper.innerHTML = `<span class="condition symbol">${
        ...
        forecast.high}${symbols.Degrees}/${forecast.low}${symbols.Degrees}</span><span class="forecast-data">${
...
function dayTemplate({ condition, high, low }) {
    ...
    wrapper.innerHTML = `<span class="symbol">${
        ...
        high}${symbols.Degrees}/${low}${symbols.Degrees}</span><span class="forecast-data">${condition}</span>`;
